...
function App() {
  ...
  return (
    <div style={{
      ...
      {/* Main content */}
      <div className="paper" style={{ maxWidth: '500px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="section">
          ...
          <div style={{ fontSize: '14px', color: '#1f2937' }}>
            {loading ? (
              ...
              <span style={{ color: '#6b7280', fontStyle: 'italic' }}>No message from server</span>
            )}
          </div>
        </div>
        ...
        <div style={{
          ...
          Create a new GitHub issue and tag <code style={{
            backgroundColor: '#f8fafc',
            padding: '2px 6px',
            borderRadius: '4px',
            fontSize: '13px',
            color: '#1f2937'
          }}>@MentatBot</code> to get started.
        </div>
      </div>
    </div>
  );
